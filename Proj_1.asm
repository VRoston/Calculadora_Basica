...
MULTIPLICACAO:
;PREPARACAO PARA A MULTIPLICACAO
    XOR DX, DX          ;ZERA BX PARA ARMAZENAR RESULTADOS
    MOV CX, 4           ;ENTRADA PARA REPITIR O LOOP 4 VEZES, CONTA COM 2 BITS

;MULTIPLICACAO
    MOV BH,NUM2         ;MULTIPLICANDO VAI SER A QUANTIDADE DE VEZES A MULTIPLICAR
    MOV BL,NUM1         ;BL VAI SER O NUMERO MULTIPLICADO
...
VOLTA:
    ...
    ADD DL,BL           ;SOMA O NUMERO MULTIPLICADO NA VARIAVEL DE RESPOSTA DL
